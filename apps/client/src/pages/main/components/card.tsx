import { GitBranch, GithubIcon, Menu, MenuSquareIcon, MoreHorizontal, MoreVertical } from 'lucide-react';
...
const Card = ({ projectName, clientDomain, serverDomain, createdAt, username }: CardProps) => {
  return (
    <Link
